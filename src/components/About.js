      ...
      >
        <div className="flex flex-col justify-around">
          <div className="sm:px-16 px-2">
            ...
            >
              👨‍💻 Hi, I'm Makwana Karan, a 2024 graduate🎓 with a passion for crafting robust
              full-stack systems and captivating mobile applications. As a seasoned{' '}
              <a
              ...
              I specialize in the{' '}
              <span className="text-2xl font-semibold text-green-500">MERN STACK.</span>
              🚀.
              <br />
              I'm also into photography📸. It's not just a hobby; I see it as a way to capture
